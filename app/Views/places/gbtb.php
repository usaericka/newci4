    ...
    <div class="container">
        <div class="row">
            <div class="col-5 mt-4 mx-2">
                <figure class="figure">
                    <img src="../images/gardens-by-the-bay.jpg" class="figure-img img-fluid rounded">
                    <figcaption class="figure-caption fw-medium text-end">Gardens by the Bay</figcaption>
                </figure>
            </div>
