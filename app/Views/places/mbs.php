    ...
    <div class="container" id="ASM">
        <div class="row">
            <div class="col-5 mx-3">
                <figure class="figure">
                    <img src="../images/asm.jpg" class="figure-img img-fluid rounded">
            ...
            <div class="col-6 mt-5 mx-4">
                <div class="card border border-dark p-2 mb-2">
                    <p class="text-justify mt-1">
                        ...
                        all ages. Visit state-of-the-art exhibitions and discover a breathtaking world through videogames
                        and audiotapes.
                    </p>
                </div>
            </div>
